        ...
        <div className={styles.frameParent}>
          <div className={styles.frameWrapper}>
            <div className={styles.uxDesignParent}>
              ...
              <div className={styles.lastEdited2hrs}>Last Edited 2hrs ago</div>
            </div>
          </div>
          ...
          <div className={styles.rectangleParent7}>
            ...
            <form className={styles.groupForm}>
              ...
              <div className={styles.rectangleParent10}>
                ...
                <button className={styles.rectangleParent11}>
                ...
                <div className={styles.mar2023OverContainer3}>
                  <span className={styles.mar20232}>{`13 Mar 2023 `}</span>
                  <span className={styles.overDue3}>(Over Due)</span>
                </div>
              ...
              <div className={styles.rectangleParent19}>
                ...
                <div className={styles.mar20235}>14 Mar 2023</div>
              ...
              <div className={styles.rectangleParent22}>
                ...
                <button className={styles.rectangleParent23}>
                  <div className={styles.frameChild28} />
                  <div className={styles.borrowed3}>Borrowed</div>
                </button>
                <button className={styles.rectangleParent24}>
                ...
                <div className={styles.mar2023OverContainer4}>
                  <span className={styles.mar20236}>{`13 Mar 2023 `}</span>
                  <span className={styles.overDue4}>(Over Due)</span>
                </div>
              ...
              <div className={styles.rectangleParent25}>
                ...
                <button className={styles.rectangleParent26}>
                  <div className={styles.frameChild32} />
                  <div className={styles.eBook2}>E-BOOK</div>
                </button>
                <button className={styles.rectangleParent27}>
                ...
                <div className={styles.mar20237}>14 Mar 2023</div>
